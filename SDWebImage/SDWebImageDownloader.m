...
- (id <SDWebImageOperation>)downloadImageWithURL:(NSURL *)url metadata:(NSDictionary *)metadata options:(SDWebImageDownloaderOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageDownloaderCompletedBlock)completedBlock {
    ...
    [self addProgressCallback:progressBlock andCompletedBlock:completedBlock forURL:url createCallback:^{
        ...
        operation = [[SDWebImageDownloaderOperation alloc] initWithRequest:request
                                                                 ...
                                                                 completed:^(UIImage *image, NSData *data, NSDictionary *responseHTTPHeaderFields, NSError *error, BOOL finished) {
                                                                     ...
                                                                     for (NSDictionary *callbacks in callbacksForURL) {
                                                                         SDWebImageDownloaderCompletedBlock callback = callbacks[kCompletedCallbackKey];
                                                                         if (callback) callback(image, data, request.allHTTPHeaderFields, error, finished);
                                                                     }
                                                                 }
                                                                 cancelled:^{
                                                                     SDWebImageDownloader *sself = wself;
